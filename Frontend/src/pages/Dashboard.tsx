      ...
      <PageTransition>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {Array.from({ length: 4 }).map((_, i) => <SkeletonCard key={i} className="h-32 rounded-[2rem]" />)}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="skeleton-loader h-[400px] rounded-[2.5rem] lg:col-span-2" />
            <div className="skeleton-loader h-[400px] rounded-[2.5rem]" />
          </div>
        </div>
      </PageTransition>
    );
